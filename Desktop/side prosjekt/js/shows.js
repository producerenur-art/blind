...
const Shows = (() => {
  ...
  const SHOWS = [
    ...
    {
      id: 'doomed-deep-night',
      name: 'Doomed Deep Night',
      host: 'Doomed — Dark Drone',
      day: 0, // Sunday
      startHour: 2, endHour: 4,
      genre: 'Dark Ambient · Drone',
      emoji: '💀',
      color: '#7f1d1d',
      desc: 'A second nightly descent into ritual dark drone before dawn breaks.',
      stream: 'doomed',
    },
    {
      id: 'block-party-radio',
      name: 'Block Party Radio',
      ...
      emoji: '🎉',
      color: '#ec4899',
      desc: 'An eclectic electronic block party — house, dance and everything in between.',
      stream: 'specials',
    },
    {
      id: 'night-drone-session',
      name: 'Night Drone Session',
      host: 'Dark Zone',
      day: 1, // Monday
      ...
      emoji: '🌑',
      color: '#0d0d1a',
      desc: 'The darker side of deep ambient carries on into the small hours of Monday.',
      stream: 'darkzone',
    },
    {
      id: 'slow-monday',
    ...
    },
    {
      ...
      emoji: '💊',
      color: '#ef4444',
      desc: 'Hypnotic techno and minimal grooves to close out Tuesday.',
      stream: 'digitalis',
    },
    {
    ...
    },
    {
      ...
      emoji: '🛰️',
      color: '#0ea5e9',
      desc: 'Spacemusic and ambient electronica through the middle of the day.',
      stream: 'spacestation',
    },
    {
      id: 'underground-cliqhop',
      name: 'Underground Cliqhop',
      host: 'Cliqhop IDM',
      day: 3, // Wednesday
      startHour: 14, endHour: 18,
      genre: 'Underground · IDM',
      emoji: '🔊',
      color: '#64748b',
      desc: 'Clicks, cuts and beeping IDM from the underground electronic fringe.',
      stream: 'cliqhop',
    },
    {
      id: 'dark-drone-vespers',
      name: 'Dark Drone Vespers',
      host: 'Doomed — Dark Drone',
      day: 4, // Thursday
      ...
      emoji: '💀',
      color: '#7f1d1d',
      desc: 'Ritual dark ambient and dark drone to open Thursday before sunrise.',
      stream: 'doomed',
    },
    {
      id: 'edm-underground-thursday',
      name: 'EDM Underground',
      host: 'DEF CON Radio',
      day: 4, // Thursday
      startHour: 7, endHour: 11,
      genre: 'EDM · Underground Techno',
      emoji: '🎛️',
      color: '#ef4444',
      desc: 'Underground techno and hacker electronica to open a Thursday morning.',
      stream: 'defcon',
    },
    {
      id: 'ambient-horizon',
      name: 'Ambient Horizon',
      host: 'Drone Zone',
      day: 4, // Thursday
