  ...
  function render() {
    ...
    app.innerHTML = `
      <div class="shows-page" id="shows-page">
        ...
        ${typeof Radio247 !== 'undefined' ? `<div class="section" style="max-width:900px">${Radio247.cardHtml('r247-shows-card', { showUntilNext: true })}</div>` : ''}
        ...
        <div class="section" style="max-width:1100px">
          ...
          ${typeof Radio247 !== 'undefined' ? `<div style="color:var(--text2);font-size:0.82rem;margin:-1rem 0 1.25rem;display:flex;align-items:center;gap:0.4rem">𓂋 𓄿 𓂧 𓇋 𓅱 SiriusFM 24/7</div>` : ''}
