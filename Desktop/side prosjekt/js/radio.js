...
const Radio = (() => {
  ...
  const STATIONS = [
    ...
    {
      id: 'cafemission', cat: 'Chill Out / Downtempo',
      name: 'Café Mission',
      url:  'https://ice2.somafm.com/cafemission-128-mp3',
      emoji: '🫖', color: '#a78bfa',
    ...
    },
    {
      ...
      emoji: '🌊', color: '#0ea5e9',
      desc: "The world's #1 chillout station",
    },
    {
      id: 'frisky-chill', cat: 'Chill Out / Downtempo',
      name: 'FRISKY Chill',
      url:  'https://stream.frisky.fm/listen/chill',
      emoji: '🧊', color: '#38bdf8',
